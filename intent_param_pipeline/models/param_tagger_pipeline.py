...
from allennlp.modules import Seq2SeqEncoder, TimeDistributed, TextFieldEmbedder, Seq2VecEncoder
...
@Model.register("pm_tagger_pipeline")
class ParamTaggerPipeline(Model):
    """
    ...
    def forward(self,  # type: ignore
                ...
                label: Dict[str, torch.LongTensor],
        ...
        embedded_label = self.text_field_embedder(label)

        embedded_text_input = self.text_field_embedder(tokens) + embedded_label
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if count:
            ...
            average_f1 = sum_f1
        metric_dict['param_average_F1'] = average_f1
